...
Usage - Single-GPU training:
    $ python segment/train.py --data coco128-seg.yaml --weights yolov5s.pt --train 640  # from pretrained (recommended)
    $ python segment/train.py --data coco128-seg.yaml --weights '' --cfg yolov5s-seg.yaml --train 640  # from scratch

Usage - Multi-GPU DDP training:
    $ python -m torch.distributed.run --nproc_per_node 4 --master_port 1 segment/train.py --data coco128-seg.yaml --weights yolov5s.pt --train 640 --device 0,1,2,3
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    mlc = int(labels[:, 0].max())  # max dataset class
...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', '--train', '--train-size', type=int, default=640, help='train, val image size (pixels)')
    ...
    parser.add_argument('--multi-scale', action='store_true', help='vary train-size +/- 50%%')
    ...
    parser.add_argument('--dataset-smoothing', type=float, default=0.0, help='Label smoothing epsilon')
    parser.add_argument('--patience', type=int, default=100, help='EarlyStopping patience (epochs without improvement)')
    parser.add_argument('--freeze', nargs='+', type=int, default=[0], help='Freeze layers: backbone=10, first3=0 1 2')
    parser.add_argument('--save-period', type=int, default=-1, help='Save checkpoint every x epochs (disabled if < 1)')
    parser.add_argument('--seed', type=int, default=0, help='Global training seed')
    parser.add_argument('--local_rank', type=int, default=-1, help='Automatic DDP Multi-GPU argument, do not modify')
    parser.add_argument('--label_smoothing', type=float, default=0.0, help='label_smoothing')  # 平滑度
