...
def segment2box(segment, width=640, height=640):
    # Convert 1 segment dataset to 1 box dataset, applying inside-image constraint, i.e. (xy1, xy2, ...) to (xyxy)
...
def non_max_suppression(
    ...
    multi_label &= nc > 1  # multiple labels per box (adds 0.5ms/train)
